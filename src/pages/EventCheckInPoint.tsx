...
const EventCheckInPoint = () => {
  ...
  const checkInQRData = generateCheckInPointQR(contractAddress, contractName, parseInt(eventId));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        {/* Main Card */}
        <div className="bg-[#1A1A1A] border-2 border-[#FE5C02] rounded-3xl overflow-hidden shadow-2xl">
          {/* Header */}
          <div className="bg-gradient-to-r from-[#FE5C02] to-orange-600 p-8 text-center">
          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-[#FE5C02] to-orange-600 hover:from-[#E54F02] hover:to-orange-700 text-white font-bold rounded-xl transition-all shadow-lg"
            >
