        ...
        <div className="bg-[#1A1A1A] border border-gray-800 rounded-2xl overflow-hidden">
          ...
          <div className="p-4 border-b border-gray-800">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#FE5C02]/10 rounded-full flex items-center justify-center">
                <Camera className="w-5 h-5 text-[#FE5C02]" />
              </div>
              <div>
          ...
          <div className="relative bg-black">
            ...
            <div className="absolute inset-0 pointer-events-none">
              {/* Corner markers */}
              <div className="absolute top-4 left-4 w-8 h-8 border-t-4 border-l-4 border-[#FE5C02]" />
              <div className="absolute top-4 right-4 w-8 h-8 border-t-4 border-r-4 border-[#FE5C02]" />
              <div className="absolute bottom-4 left-4 w-8 h-8 border-b-4 border-l-4 border-[#FE5C02]" />
              <div className="absolute bottom-4 right-4 w-8 h-8 border-b-4 border-r-4 border-[#FE5C02]" />
            </div>
