            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  <Badge variant="secondary" className="bg-[#FE5C02] text-white">
      ...
      {activeTab === 'overview' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="bg-[#1A1A1A] border-gray-800">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">
                <Ticket className="w-5 h-5 text-[#FE5C02]" />
                Ticket Details
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <Badge className="bg-[#FE5C02] text-white">{metadata.properties.ticket.tier}</Badge>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div className="bg-[#0A0A0A] border border-gray-800 rounded-lg p-4">
                  ...
                  <Badge className={metadata.properties.utility.earlyAccess ? 'bg-[#FE5C02]' : 'bg-gray-600'}>
            ...
            <div className="space-y-4">
              {metadata.provenance.history.map((event, index) => (
                <div key={index} className="flex items-start gap-4 p-4 bg-[#0A0A0A] border border-gray-800 rounded-lg">
                  <div className="w-10 h-10 rounded-full bg-[#FE5C02] flex items-center justify-center flex-shrink-0">
