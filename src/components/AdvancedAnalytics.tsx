    ...
    try {
      ...
      const mockData: AnalyticsData = {
        ...
        spending: {
          ...
          byCategory: [
            { category: 'Music', amount: 2850, percentage: 45, color: '#FE5C02' },
        ...
        <div className="flex gap-2">
          {(['7d', '30d', '90d', '1y'] as const).map((range) => (
            <Button
              ...
              className={timeRange === range ? 'bg-[#FE5C02]' : ''}
            >
              {range}
            </Button>
          ))}
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            {[
              { label: 'Total Value', value: formatCurrency(data.portfolio.totalValue), change: data.portfolio.totalChange, icon: DollarSign, color: 'from-[#FE5C02] to-orange-600' },
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data.spending.monthly}>
                  ...
                  />
                  <Legend />
                  <Line type="monotone" dataKey="spending" stroke="#FE5C02" strokeWidth={3} name="Spending" />
                  ...
                  {data.market.topEvents.map((event, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-[#0A0A0A] rounded-lg">
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">{formatCurrency(event.totalSales)} total sales</p>
                      </div>
                      <div className="text-right">
                        <p className="text-white font-medium">{formatCurrency(event.avgPrice)}</p>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={data.market.trends} layout="horizontal">
                    ...
                    />
                    <Bar dataKey="growth" fill="#FE5C02" />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
          ...
          <Card className="bg-[#1A1A1A] border-gray-800">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">
                <Target className="w-5 h-5 text-[#FE5C02]" />
                Portfolio Growth Prediction
              </CardTitle>
                  ...
                  <div key={index} className="p-4 bg-[#0A0A0A] border border-gray-800 rounded-lg">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="flex-1 bg-gray-700 rounded-full h-2">
                        <div
                          className="bg-[#FE5C02] h-2 rounded-full"
