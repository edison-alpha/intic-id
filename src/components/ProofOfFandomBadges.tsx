      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-4 bg-[#0A0A0A] border-2 border-gray-800 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            <Zap className="w-4 h-4 text-[#FE5C02]" />
                ...
                <ul className="space-y-2">
                  {selectedBadge.perks.map((perk, index) => (
                    <li key={index} className="flex items-start gap-2 text-gray-300 text-sm">
                      <Star className="w-4 h-4 text-[#FE5C02] flex-shrink-0 mt-0.5" />
                      <span>{perk}</span>
                    </li>
                  ))}
                </ul>
                ...
                <div className="space-y-3">
                  {selectedBadge.nftId ? (
                    ...
                    <button
                      ...
                      className="w-full py-3 bg-[#FE5C02] hover:bg-[#E54F02] text-white font-bold rounded-lg transition-colors"
                    >
                      Mint NFT Badge
                    </button>
                  )}
