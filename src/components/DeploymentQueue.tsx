  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-bold bg-gradient-to-r from-[#FE5C02] to-orange-400 bg-clip-text text-transparent">
            Contract Management
          </h2>
      ...
      <Card className="bg-[#0A0A0A] border-gray-800">
        <CardHeader className="border-b border-gray-800">
          <CardTitle className="flex items-center gap-2 text-white">
            <Filter className="w-5 h-5 text-[#FE5C02]" />
            Filters
          </CardTitle>
        </CardHeader>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-[#1A1A1A] border-gray-700 text-white placeholder:text-gray-500 focus:border-[#FE5C02] focus:ring-[#FE5C02]"
                />
              </div>
            </div>
            <div className="w-full md:w-48">
              <select
                ...
                className="w-full p-2 bg-[#1A1A1A] border border-gray-700 text-white rounded-md focus:ring-2 focus:ring-[#FE5C02] focus:border-[#FE5C02] transition-all"
              >
            ...
            <div className="space-y-4">
              {filteredDeployments.map((deployment) => (
                <Card 
                  ...
                  className="bg-[#1A1A1A] border-gray-800 border-l-4 border-l-[#FE5C02] hover:border-l-orange-400 transition-all duration-300 hover:shadow-lg hover:shadow-[#FE5C02]/10"
                >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div>
                            ...
                            <div className="font-mono font-semibold text-[#FE5C02]">#{deployment.queueId}</div>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <div className="font-semibold text-white">{deployment.ticketPrice} sBTC</div>
                          </div>
                          <div>
                            <span className="text-gray-500">Fee Paid:</span>
                            <div className="font-semibold text-[#FE5C02]">{deployment.feePaid} sBTC</div>
                          </div>
                        </div>
                          ...
                          <div className="mt-4 p-4 bg-gradient-to-r from-green-500/10 to-green-600/5 border border-green-500/20 rounded-lg">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex gap-2">
                                ...
                                <Button
                                  size="sm"
                                  className="bg-[#FE5C02] hover:bg-orange-600 text-white"
            ...
            <CardContent className="space-y-4 pt-6">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="font-semibold">{selectedDeployment.ticketPrice} sBTC</div>
                </div>
                <div>
                  <span className="text-gray-600">Fee Paid:</span>
                  <div className="font-semibold">{selectedDeployment.feePaid} sBTC</div>
                </div>
                <div>
              ...
              <div className="flex justify-end gap-2">
                ...
                {selectedDeployment.contractAddress && (
                  <Button
                    ...
                    className="bg-[#FE5C02] hover:bg-[#E54F02]"
                  >
